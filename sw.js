...
const ASSETS = [
  ...
  'codes.html', 'dashboard.html', 'store.html', 'accounts.html', 'admin.html', 'submits.html', 'manifest.json',
  ...
  'css/app.css',
  'js/auth.js', 'js/api.js', 'js/maint.js',
 'js/ui-busy.js', 'js/menu.js', 'js/scoring.js', 'js/ui-time.js', 'js/ui-photo.js',
  'js/qsc-app.js', 'js/shopper-core.js', 'js/codes-app.js',
  'js/login-app.js', 'js/dashboard-app.js', 'js/store-app.js', 'js/accounts-app.js', 'js/submits-app.js',
].map(v));
